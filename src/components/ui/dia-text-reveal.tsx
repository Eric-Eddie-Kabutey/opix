...
> {
  ...
  fixedWidth?: boolean
  /**
   * Called when the reveal sweep finishes. Also fires immediately under reduced
   * motion (when the text is shown without animating). Useful to chain follow-on
   * content (e.g. reveal a subheadline once the headline has finished).
   */
  onComplete?: () => void
}
